...
const DutchBanglaDetails = ({exchange}) => {
    ...
    return (
        <>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 bg-[#f9f9f9] border-l border-r border-t border-b border-gray-300 py-3 px-2 justify-between rounded">
                            <p className="font-bold">Exchange ID</p>
                            <p className="uppercase">{_id}</p>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 border-l border-r border-b border-gray-300 py-3 px-2 justify-between rounded">
                            <p className="font-bold">User Name</p>
                            <p>{username}</p>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 bg-[#f9f9f9] border-l border-r border-b border-gray-300 py-3 px-2 justify-between rounded">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 border-l border-r border-b border-gray-300 py-3 px-2 justify-between rounded">
                            <p className="font-bold">DBBL Account Name</p>
                            <p>{accountName}</p>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 bg-[#f9f9f9] border-l border-r border-b border-gray-300 py-3 px-2 justify-between rounded">
                            <p className="font-bold">DBBL Account Number</p>
                            <p>{accountNumber}</p>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 border-l border-r border-b border-gray-300 py-3 px-2 justify-between rounded">
                            <p className="font-bold">Contact Number 01</p>
                            <p>{contactNumber}</p>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 bg-[#f9f9f9] border-l border-r border-b border-gray-300 py-3 px-2 justify-between rounded">
                            <p className="font-bold">Contact Number 02</p>
                            <p>{contactNumber2}</p>
                        </div>
